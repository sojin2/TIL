...
class ViewController: UIViewController,WKNavigationDelegate {
    ...
    // url의 인수를 통해 웹 페이지의 주소를 전달 받아 웹 페이지를 보여 줌
    ...
    override func viewDidLoad() {
        ...
        loadWebPage("https://2sam.net") // 앱 실행 초기 홈페이지를 불러옴
    ...
    //[Site1] 버튼 클릭 시 fallinmac.tistory.com 으로 이동
    ...
    // HTML 문법에 맞게 작성된 뭄ㄴ자열 변수를 웹 뷰로 나타냄
