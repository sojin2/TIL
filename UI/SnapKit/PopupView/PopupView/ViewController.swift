...
class ViewController: UIViewController {
  ...
  override func viewDidLoad() {
    super.viewDidLoad()
      ...
      self.button2.addTarget(self, action: #selector(self.didTapButton), for: .touchUpInside)
      self.button3.addTarget(self, action: #selector(self.didTapButton2), for: .touchUpInside)
      self.button4.addTarget(self, action: #selector(self.didTapButton3), for: .touchUpInside)
