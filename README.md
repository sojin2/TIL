...
- 더 자세한 설명이 필요할때는 블로그에 포스팅합니다. [지니의 개발 창고](https://coding-sojin2.tistory.com/](https://develop-ssooo.tistory.com/)
...
- [Basic](https://github.com/giftbott/iOSDevLinks#basic)
- [Apple Programming Guide](https://github.com/giftbott/iOSDevLinks#apple-programming-guide)
- [Community](https://github.com/giftbott/iOSDevLinks#community)
- [Conference](https://github.com/giftbott/iOSDevLinks#conference)
- [Conference Video List](https://github.com/giftbott/iOSDevLinks#conference-video-list)
- [Blog](https://github.com/giftbott/iOSDevLinks#blog)
- [Mailing List](https://github.com/giftbott/iOSDevLinks#mailing-list)
- [Device Specification](https://github.com/giftbott/iOSDevLinks#device-specification)
- [Icon](https://github.com/giftbott/iOSDevLinks#icon)
- [Color](https://github.com/giftbott/iOSDevLinks#color)
- [Font](https://github.com/giftbott/iOSDevLinks#font)
- [Sound](https://github.com/giftbott/iOSDevLinks#sound)
- [Image](https://github.com/giftbott/iOSDevLinks#image)
- [Git](https://github.com/giftbott/iOSDevLinks#git)
- [GitHub](https://github.com/giftbott/iOSDevLinks#github)
- [Dependency Manager](https://github.com/giftbott/iOSDevLinks#dependency-manager)
- [Collections](https://github.com/giftbott/iOSDevLinks#collections)
- [Theme](https://github.com/giftbott/iOSDevLinks#theme)
- [Patterns](https://github.com/giftbott/iOSDevLinks#patterns)
- [Markdown](https://github.com/giftbott/iOSDevLinks#markdown)
- [Design](https://github.com/giftbott/iOSDevLinks#design)
- [Online Playground](https://github.com/giftbott/iOSDevLinks#online-playground)
- [Prototyping Tool](https://github.com/giftbott/iOSDevLinks#prototyping-tool)
- [Learning](https://github.com/giftbott/iOSDevLinks#learning)
- [Platform / Open API](https://github.com/giftbott/iOSDevLinks#platforms--open-api)
- [Networking](https://github.com/giftbott/iOSDevLinks#networking)
- [JSON Parsing Helper](https://github.com/giftbott/iOSDevLinks#json-parsing-helper)
- [Mobile DataBase](https://github.com/giftbott/iOSDevLinks#mobile-database)
- [Automation](https://github.com/giftbott/iOSDevLinks#automation)
- [Analytics](https://github.com/giftbott/iOSDevLinks#analytics)
- [AD](https://github.com/giftbott/iOSDevLinks#ad)
- [CI](https://github.com/giftbott/iOSDevLinks#ci)
- [Converter](https://github.com/giftbott/iOSDevLinks#converter)
- [Tool](https://github.com/giftbott/iOSDevLinks#tool)
- [Algorithm](https://github.com/giftbott/iOSDevLinks#algorithm)
- [Regular Expression](https://github.com/giftbott/iOSDevLinks#regular-expression)
- [Recruit](https://github.com/giftbott/iOSDevLinks#recruit)
- [Report](https://github.com/giftbott/iOSDevLinks#report)
- [etc](https://github.com/giftbott/iOSDevLinks#etc)
...
iOS 개발자들에게 유용한 사이트를 모아 카테고리별로 정리한 링크 목록입니다.처음 시작하는 분들이 조금이라도 쉽게 접근하는데 도움이 되었으면 합니다.

링크가 깨지거나 다른 문제가 있을 경우 알려주세요.추천할 만한 링크는 같이 공유 해주시면 좋겠습니다.
...
- [UDACITY](https://www.udacity.com/)
- [Udemy](https://www.udemy.com/)
- [Fastcampus](https://www.udemy.com/)
